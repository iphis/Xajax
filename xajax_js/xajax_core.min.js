...
xajax.config.cursor={update:function(){return{onWaiting:function(){if(xajax.config.baseDocument.body)xajax.config.baseDocument.body.style.cursor="wait"},onComplete:function(){xajax.config.baseDocument.body.style.cursor="auto"}}},dontUpdate:function(){return{onWaiting:function(){},onComplete:function(){}}}};xajax.get=function(obj,ident){if("object"===typeof obj&&"string"===typeof ident&&ident in obj)return obj[ident];return void 0};xajax.tools={};
xajax.tools.$=function(sId){var oDoc=xajax.config.baseDocument;if(!sId)return null;var obj;if("object"===typeof sId)if(undefined!==sId.id){obj=oDoc.getElementById(sId.id);if(obj)return obj}if(typeof sId!=="string")return sId;obj=oDoc.getElementById(sId);if(obj)return obj;if(oDoc.all)return oDoc.all[sId];return obj};xajax.tools.in_array=function(array,valueToCheck){var i=0;var l=array.length;while(i<l){if(array[i]==valueToCheck)return true;++i}return false};
xajax.tools.doubleQuotes=function(haystack){if(typeof haystack=="undefined")return false;return haystack.replace(new RegExp("'","g"),'"')};xajax.tools._enforceDataType=function(value){value=String(value);var type=value.substr(0,1);value=value.substr(1);if("*"==type)value=null;else if("N"==type)value=value-0;else if("B"==type)value=!!value;return value};
xajax.tools._nodeToObject=function(node){if(null==node)return"";if("undefined"!==typeof node.nodeName)if("#cdata-section"===node.nodeName||"#text"===node.nodeName){var data="";do if(node.data)data+=node.data;while(node=node.nextSibling);return xajax.tools._enforceDataType(data)}else if("xjxobj"===node.nodeName){var key=null;var value=null;var data=[];var child=node.firstChild;while(child){if("e"===child.nodeName){var grandChild=child.firstChild;while(grandChild){if("k"===grandChild.nodeName)key=xajax.tools._enforceDataType(grandChild.firstChild.data);
else if("v"===grandChild.nodeName)value=xajax.tools._nodeToObject(grandChild.firstChild);grandChild=grandChild.nextSibling}if(null!=key){data[key]=value;key=value=null}}child=child.nextSibling}return data}throw{code:10001,data:node.nodeName};};
xajax.tools.getRequestObject=function(){if("undefined"!=typeof XMLHttpRequest)xajax.tools.getRequestObject=function(){return new XMLHttpRequest};else if("undefined"!=typeof ActiveXObject)xajax.tools.getRequestObject=function(){try{return new ActiveXObject("Msxml2.XMLHTTP.4.0")}catch(e){xajax.tools.getRequestObject=function(){try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(e2){xajax.tools.getRequestObject=function(){return new ActiveXObject("Microsoft.XMLHTTP")};return xajax.tools.getRequestObject()}};
...
xajax.tools.willChange=function(element,attribute,newData){element=xajax.$(element);if(element){var oldData;try{oldData=element.attribute}catch(error){eval("oldData=element."+attribute)}return newData!==oldData}return false};
...
xajax.tools._getFormValue=function(aFormValues,child,submitDisabledElements,prefix){if(!child.name)return;if("PARAM"==child.tagName)return;if(child.disabled)if(true==child.disabled)if(false==submitDisabledElements)return;if(prefix!=child.name.substring(0,prefix.length))return;if(child.type)if(child.type=="radio"||child.type=="checkbox")if(false==child.checked)return;var name=child.name;var values=[];if("select-multiple"==child.type){var jLen=child.length;for(var j=0;j<jLen;++j){var option=child.options[j];
if(true==option.selected)values.push(option.value)}}else values=child.value;var keyBegin=name.indexOf("[");if(0<=keyBegin){var n=name;var k=n.substr(0,n.indexOf("["));var a=n.substr(n.indexOf("["));if(typeof aFormValues[k]=="undefined")aFormValues[k]={};var p=aFormValues;while(a.length!=0){var sa=a.substr(0,a.indexOf("]")+1);var lk=k;var lp=p;a=a.substr(a.indexOf("]")+1);p=p[k];k=sa.substr(1,sa.length-2);if(k=="")if("select-multiple"==child.type){k=lk;p=lp}else k=p.length;if(typeof k=="undefined"){k=
0;for(var i in lp[lk])k++}if(typeof p[k]=="undefined")p[k]={}}p[k]=values}else aFormValues[name]=values};xajax.tools.stripOnPrefix=function(sEventName){sEventName=sEventName.toLowerCase();if(0==sEventName.indexOf("on"))sEventName=sEventName.replace(/on/,"");return sEventName};xajax.tools.addOnPrefix=function(sEventName){sEventName=sEventName.toLowerCase();if(0!=sEventName.indexOf("on"))sEventName="on"+sEventName;return sEventName};xajax.tools.xml={};
xajax.tools.xml.parseAttributes=function(child,obj){var iLen=child.attributes.length;for(var i=0;i<iLen;++i){var attr=child.attributes[i];obj[attr.name]=attr.value}};
...
grandChild.data}else if("undefined"!=typeof child.data)obj.data=child.data;obj.data=xajax.tools._enforceDataType(obj.data)};
...
xajax.js.waitFor=function(args){args.fullName="waitFor";var bResult=false;var cmdToEval="bResult = (";cmdToEval+=args.data;cmdToEval+=");";try{args.context.xajaxDelegateCall=function(){eval(cmdToEval)};args.context.xajaxDelegateCall()}catch(e){}if(false==bResult)if(xajax.tools.queue.retry(args,args.prop)){xajax.tools.queue.setWakeup(xajax.response,100);return false}return true};
xajax.js.call=function(args){args.fullName="call js function";var parameters=args.data;var scr=[];scr.push(args.func);scr.push("(");if("undefined"!=typeof parameters)if("object"==typeof parameters){var iLen=parameters.length;if(0<iLen){scr.push("parameters[0]");for(var i=1;i<iLen;++i)scr.push(", parameters["+i+"]")}}scr.push(");");args.context.xajaxDelegateCall=function(){eval(scr.join(""))};args.context.xajaxDelegateCall();return true};
xajax.js.setFunction=function(args){args.fullName="setFunction";var code=[];code.push(args.func);code.push(" = function(");if("object"==typeof args.prop){var separator="";for(var m in args.prop){code.push(separator);code.push(args.prop[m]);separator=","}}else code.push(args.prop);code.push(") { ");code.push(args.data);code.push(" }");args.context.xajaxDelegateCall=function(){eval(code.join(""))};args.context.xajaxDelegateCall();return true};
xajax.js.wrapFunction=function(args){args.fullName="wrapFunction";var code=[];code.push(args.func);code.push(" = xajax.js.makeWrapper(");code.push(args.func);code.push(", args.prop, args.data, args.type, args.context);");args.context.xajaxDelegateCall=function(){eval(code.join(""))};args.context.xajaxDelegateCall();return true};
xajax.js.makeWrapper=function(origFun,args,codeBlocks,returnVariable,context){var originalCall="";if(0<returnVariable.length){originalCall+=returnVariable;originalCall+=" = "}var originalCall="origFun(";originalCall+=args;originalCall+="); ";var code="wrapper = function(";code+=args;code+=") { ";if(0<returnVariable.length){code+=" var ";code+=returnVariable;code+=" = null;"}var separator="";var bLen=codeBlocks.length;for(var b=0;b<bLen;++b){code+=separator;code+=codeBlocks[b];separator=originalCall}if(0<
returnVariable.length){code+=" return ";code+=returnVariable;code+=";"}code+=" } ";var wrapper=null;context.xajaxDelegateCall=function(){eval(code)};context.xajaxDelegateCall();return wrapper};
xajax.attr={has:function(ele){var hasAttrib=false;try{hasAttrib=xajax.tools.$(xajax.get(ele,"id")).hasAttribute(xajax.get(ele,"prop"))}catch(error){throw error;}return hasAttrib},add:function(ele){if(!xajax.attr.has(ele)){var elem=xajax.tools.$(xajax.get(ele,"id"));try{var data=xajax.get(ele,"data");var value=xajax.get(data,"value");value=typeof value==="string"?value:"";elem.setAttribute(xajax.get(ele,"prop"),value)}catch(error){throw error;}return true}},remove:function(ele){if(xajax.attr.has(ele)){var elem=
xajax.tools.$(xajax.get(ele,"id"));try{elem.removeAttribute(xajax.get(ele,"prop"))}catch(error){throw error;}return true}},replace:function(ele){if(xajax.attr.has(ele))xajax.attr.remove(ele);var data=xajax.get(ele,"data");ele.prop=xajax.get(data,"new");return xajax.attr.add(ele)}};xajax.dom={};
xajax.dom.assign=function(element,property,data){element=xajax.$(element);switch(property){case "innerHTML":element.innerHTML=data;break;case "outerHTML":if("undefined"===typeof element.outerHTML){var r=xajax.config.baseDocument.createRange();r.setStartBefore(element);var df=r.createContextualFragment(data);element.parentNode.replaceChild(df,element)}else element.outerHTML=data;break;default:if(xajax.tools.willChange(element,property,data))eval("element."+property+" = data;");break}return true};
xajax.dom.append=function(element,property,data){if("string"==typeof element)element=xajax.$(element);eval("element."+property+" += data;");return true};xajax.dom.prepend=function(element,property,data){if("string"==typeof element)element=xajax.$(element);eval("element."+property+" = data + element."+property);return true};
xajax.dom.replace=function(element,sAttribute,aData){var sSearch=aData["s"];var sReplace=aData["r"];if(sAttribute=="innerHTML")sSearch=xajax.tools.getBrowserHTML(sSearch);if("string"==typeof element)element=xajax.$(element);eval("var txt = element."+sAttribute);var bFunction=false;if("function"==typeof txt){txt=txt.join("");bFunction=true}var start=txt.indexOf(sSearch);if(start>-1){var newTxt=[];while(start>-1){var end=start+sSearch.length;newTxt.push(txt.substr(0,start));newTxt.push(sReplace);txt=
txt.substr(end,txt.length-end);start=txt.indexOf(sSearch)}newTxt.push(txt);newTxt=newTxt.join("");if(bFunction)eval("element."+sAttribute+"=newTxt;");else if(xajax.tools.willChange(element,sAttribute,newTxt))eval("element."+sAttribute+"=newTxt;")}return true};xajax.dom.remove=function(element){if("string"==typeof element)element=xajax.$(element);if(element&&element.parentNode&&element.parentNode.removeChild)element.parentNode.removeChild(element);return true};
xajax.dom.create=function(objParent,sTag,sId){if("string"==typeof objParent)objParent=xajax.$(objParent);var target=xajax.config.baseDocument.createElement(sTag);target.setAttribute("id",sId);if(objParent)objParent.appendChild(target);return true};xajax.dom.insert=function(objSibling,sTag,sId){if("string"==typeof objSibling)objSibling=xajax.$(objSibling);var target=xajax.config.baseDocument.createElement(sTag);target.setAttribute("id",sId);objSibling.parentNode.insertBefore(target,objSibling);return true};
...
xajax.dom.contextAssign=function(args){args.fullName="context assign";var code=[];code.push("this.");code.push(args.prop);code.push(" = data;");code=code.join("");args.context.xajaxDelegateCall=function(data){eval(code)};args.context.xajaxDelegateCall(args.data);return true};
xajax.dom.contextAppend=function(args){args.fullName="context append";var code=[];code.push("this.");code.push(args.prop);code.push(" += data;");code=code.join("");args.context.xajaxDelegateCall=function(data){eval(code)};args.context.xajaxDelegateCall(args.data);return true};
xajax.dom.contextPrepend=function(args){args.fullName="context prepend";var code=[];code.push("this.");code.push(args.prop);code.push(" = data + this.");code.push(args.prop);code.push(";");code=code.join("");args.context.xajaxDelegateCall=function(data){eval(code)};args.context.xajaxDelegateCall(args.data);return true};xajax.domResponse={};xajax.domResponse.startResponse=function(args){xjxElm=[]};xajax.domResponse.createElement=function(args){eval([args.tgt," = document.createElement(args.data)"].join(""))};
xajax.domResponse.setAttribute=function(args){args.context.xajaxDelegateCall=function(){eval([args.tgt,".setAttribute(args.key, args.data)"].join(""))};args.context.xajaxDelegateCall()};xajax.domResponse.appendChild=function(args){args.context.xajaxDelegateCall=function(){eval([args.par,".appendChild(",args.data,")"].join(""))};args.context.xajaxDelegateCall()};
xajax.domResponse.insertBefore=function(args){args.context.xajaxDelegateCall=function(){eval([args.tgt,".parentNode.insertBefore(",args.data,", ",args.tgt,")"].join(""))};args.context.xajaxDelegateCall()};xajax.domResponse.insertAfter=function(args){args.context.xajaxDelegateCall=function(){eval([args.tgt,"parentNode.insertBefore(",args.data,", ",args.tgt,".nextSibling)"].join(""))};args.context.xajaxDelegateCall()};
xajax.domResponse.appendText=function(args){args.context.xajaxDelegateCall=function(){eval([args.par,".appendChild(document.createTextNode(args.data))"].join(""))};args.context.xajaxDelegateCall()};
xajax.domResponse.removeChildren=function(args){var skip=args.skip||0;var remove=args.remove||-1;var element=null;args.context.xajaxDelegateCall=function(){eval(["element = ",args.data].join(""))};args.context.xajaxDelegateCall();var children=element.childNodes;for(var i in children)if(isNaN(i)==false&&children[i].nodeType==1)if(skip>0)skip=skip-1;else if(remove!=0){if(remove>0)remove=remove-1;element.removeChild(children[i])}};xajax.domResponse.endResponse=function(args){xjxElm=[]};xajax.css={};
...
xajax.forms.insertInputAfter=function(command){command.fullName="insertInputAfter";var objSibling=command.id;var sType=command.type;var sName=command.data;var sId=command.prop;if("string"==typeof objSibling)objSibling=xajax.$(objSibling);var target=xajax.forms.getInput(sType,sName,sId);if(target&&objSibling&&objSibling.parentNode)objSibling.parentNode.insertBefore(target,objSibling.nextSibling);return true};xajax.events={};
...
xajax.events.addHandler=function(element,sEvent,fun){if(window.addEventListener)xajax.events.addHandler=function(command){command.fullName="addHandler";var element=command.id;var sEvent=command.prop;var fun=command.data;if("string"==typeof element)element=xajax.$(element);sEvent=xajax.tools.stripOnPrefix(sEvent);eval('element.addEventListener("'+sEvent+'", '+fun+", false);");return true};else xajax.events.addHandler=function(command){command.fullName="addHandler";var element=command.id;var sEvent=
command.prop;var fun=command.data;if("string"==typeof element)element=xajax.$(element);sEvent=xajax.tools.addOnPrefix(sEvent);eval('element.attachEvent("'+sEvent+'", '+fun+", false);");return true};return xajax.events.addHandler(element,sEvent,fun)};
xajax.events.removeHandler=function(element,sEvent,fun){if(window.removeEventListener)xajax.events.removeHandler=function(command){command.fullName="removeHandler";var element=command.id;var sEvent=command.prop;var fun=command.data;if("string"==typeof element)element=xajax.$(element);sEvent=xajax.tools.stripOnPrefix(sEvent);eval('element.removeEventListener("'+sEvent+'", '+fun+", false);");return true};else xajax.events.removeHandler=function(command){command.fullName="removeHandler";var element=
command.id;var sEvent=command.prop;var fun=command.data;if("string"==typeof element)element=xajax.$(element);sEvent=xajax.tools.addOnPrefix(sEvent);eval('element.detachEvent("'+sEvent+'", '+fun+", false);");return true};return xajax.events.removeHandler(element,sEvent,fun)};xajax.callback={};
...
xajax.command.handler.register("css",function(args){args.fullName="includeCSS";if("undefined"==typeof args.media)args.media="screen";return xajax.css.add(args.data,args.media)});xajax.command.handler.register("rcss",function(args){args.fullName="removeCSS";if("undefined"==typeof args.media)args.media="screen";return xajax.css.remove(args.data,args.media)});xajax.command.handler.register("wcss",function(args){args.fullName="waitForCSS";return xajax.css.waitForCSS(args)});
xajax.command.handler.register("as",function(args){args.fullName="assign/clear";try{return xajax.dom.assign(args.target,args.prop,args.data)}catch(e){}return true});xajax.command.handler.register("ap",function(args){args.fullName="append";return xajax.dom.append(args.target,args.prop,args.data)});xajax.command.handler.register("pp",function(args){args.fullName="prepend";return xajax.dom.prepend(args.target,args.prop,args.data)});
xajax.command.handler.register("rp",function(args){args.fullName="replace";return xajax.dom.replace(args.id,args.prop,args.data)});xajax.command.handler.register("rm",function(args){args.fullName="remove";return xajax.dom.remove(args.id)});xajax.command.handler.register("ce",function(args){args.fullName="create";return xajax.dom.create(args.id,args.data,args.prop)});xajax.command.handler.register("ie",function(args){args.fullName="insert";return xajax.dom.insert(args.id,args.data,args.prop)});
xajax.command.handler.register("ia",function(args){args.fullName="insertAfter";return xajax.dom.insertAfter(args.id,args.data,args.prop)});xajax.command.handler.register("DSR",xajax.domResponse.startResponse);xajax.command.handler.register("DCE",xajax.domResponse.createElement);xajax.command.handler.register("DSA",xajax.domResponse.setAttribute);xajax.command.handler.register("DAC",xajax.domResponse.appendChild);xajax.command.handler.register("DIB",xajax.domResponse.insertBefore);
xajax.command.handler.register("DIA",xajax.domResponse.insertAfter);xajax.command.handler.register("DAT",xajax.domResponse.appendText);xajax.command.handler.register("DRC",xajax.domResponse.removeChildren);xajax.command.handler.register("DER",xajax.domResponse.endResponse);xajax.command.handler.register("attr:ad",xajax.attr.add);xajax.command.handler.register("attr:re",xajax.attr.remove);xajax.command.handler.register("attr:rp",xajax.attr.replace);xajax.command.handler.register("c:as",xajax.dom.contextAssign);
...
xajax.command.handler.register("ev",xajax.events.setEvent);xajax.command.handler.register("ah",xajax.events.addHandler);xajax.command.handler.register("rh",xajax.events.removeHandler);xajax.command.handler.register("dbg",function(args){args.fullName="debug message";return true});
...
typeof oRequest.URI)throw{code:10005};};
xajax.processParameters=function(oRequest){var xx=xajax;var xt=xx.tools;var rd=[];var separator="";for(var sCommand in oRequest.functionName)if("constructor"!=sCommand){rd.push(separator);rd.push(sCommand);rd.push("=");rd.push(encodeURIComponent(oRequest.functionName[sCommand]));separator="&"}var dNow=new Date;rd.push("&xjxr=");rd.push(dNow.getTime());delete dNow;if(oRequest.parameters){var i=0;var iLen=oRequest.parameters.length;while(i<iLen){var oVal=oRequest.parameters[i];if("object"==typeof oVal&&
null!=oVal){try{oVal=JSON.stringify(oVal)}catch(e){oVal=""}rd.push("&xjxargs[]=");oVal=encodeURIComponent(oVal);rd.push(oVal);++i}else{rd.push("&xjxargs[]=");if("undefined"==typeof oVal||null==oVal)rd.push("*");else{var sType=typeof oVal;if("string"==sType)rd.push("S");else if("boolean"==sType)rd.push("B");else if("number"==sType)rd.push("N");oVal=encodeURIComponent(oVal);rd.push(oVal)}++i}}}oRequest.requestURI=oRequest.URI;if("GET"==oRequest.method){oRequest.requestURI+=oRequest.requestURI.indexOf("?")==
-1?"?":"&";oRequest.requestURI+=rd.join("");rd=[]}oRequest.requestData=rd.join("")};
xajax.prepareRequest=function(oRequest){var xx=xajax;var xt=xx.tools;oRequest.request=xt.getRequestObject();oRequest.setRequestHeaders=function(headers){if("object"==typeof headers)for(var optionName in headers)this.request.setRequestHeader(optionName,headers[optionName])};oRequest.setCommonRequestHeaders=function(){this.setRequestHeaders(this.commonHeaders);if(this.challengeResponse)this.request.setRequestHeader("challenge-response",this.challengeResponse)};oRequest.setPostRequestHeaders=function(){this.setRequestHeaders(this.postHeaders)};
oRequest.setGetRequestHeaders=function(){this.setRequestHeaders(this.getHeaders)};if("asynchronous"==oRequest.mode){oRequest.request.onreadystatechange=function(){if(oRequest.request.readyState!=4)return;xajax.responseReceived(oRequest)};oRequest.finishRequest=function(){return this.returnValue}}else oRequest.finishRequest=function(){return xajax.responseReceived(oRequest)};if("undefined"!=typeof oRequest.userName&&"undefined"!=typeof oRequest.password)oRequest.open=function(){this.request.open(this.method,
this.requestURI,"asynchronous"==this.mode,oRequest.userName,oRequest.password)};else oRequest.open=function(){this.request.open(this.method,this.requestURI,"asynchronous"==this.mode)};if("POST"==oRequest.method)oRequest.applyRequestHeaders=function(){this.setCommonRequestHeaders();try{this.setPostRequestHeaders()}catch(e){this.method="GET";this.requestURI+=this.requestURI.indexOf("?")==-1?"?":"&";this.requestURI+=this.requestData;this.requestData="";if(0==this.requestRetry)this.requestRetry=1;throw e;
...
xajax.completeResponse=function(oRequest){xajax.callback.execute([xajax.callback.global,oRequest.callback],"onComplete",oRequest);oRequest.cursor.onComplete();oRequest.status.onComplete();delete oRequest["functionName"];delete oRequest["requestURI"];delete oRequest["requestData"];delete oRequest["requestRetry"];delete oRequest["request"];delete oRequest["set"];delete oRequest["open"];delete oRequest["setRequestHeaders"];delete oRequest["setCommonRequestHeaders"];delete oRequest["setPostRequestHeaders"];
delete oRequest["setGetRequestHeaders"];delete oRequest["applyRequestHeaders"];delete oRequest["finishRequest"];delete oRequest["status"];delete oRequest["cursor"];delete oRequest["challengeResponse"]};xajax.$=xajax.tools.$;xajax.getFormValues=xajax.tools.getFormValues;xajax.isLoaded=true;xjx={};xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if("undefined"==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+"xajax_js/JSON.js"});
