...
<form id="testForm1" onsubmit="return false;">
	...
	<p><input type="submit" value="Submit Normal"
			  onclick="xajax_testForm(xajax.getFormValues('testForm1')); return false;" /></p>

	<p><input type="submit" value="Submit Everything"
			  onclick="xajax_testForm(xajax.getFormValues('testForm1', true)); return false;" /></p>
</form>
